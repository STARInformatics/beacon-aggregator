...
public class StatementsApi {
    ...
    private com.squareup.okhttp.Call getStatementsValidateBeforeCall(List<String> c, Integer pageNumber, Integer pageSize, String keywords, String semanticGroups, String relations, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStatementsCall(c, pageNumber, pageSize, keywords, semanticGroups, relations, progressListener, progressRequestListener);
        return call;
     ...
     */
    public List<BeaconStatement> getStatements(List<String> c, Integer pageNumber, Integer pageSize, String keywords, String semanticGroups, String relations) throws ApiException {
        ApiResponse<List<BeaconStatement>> resp = getStatementsWithHttpInfo(c, pageNumber, pageSize, keywords, semanticGroups, relations);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<BeaconStatement>> getStatementsWithHttpInfo(List<String> c, Integer pageNumber, Integer pageSize, String keywords, String semanticGroups, String relations) throws ApiException {
        com.squareup.okhttp.Call call = getStatementsValidateBeforeCall(c, pageNumber, pageSize, keywords, semanticGroups, relations, null, null);
     ...
     */
    public com.squareup.okhttp.Call getStatementsAsync(List<String> c, Integer pageNumber, Integer pageSize, String keywords, String semanticGroups, String relations, final ApiCallback<List<BeaconStatement>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStatementsValidateBeforeCall(c, pageNumber, pageSize, keywords, semanticGroups, relations, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<BeaconStatement>>(){}.getType();
