...
public class StatementsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<BeaconStatement> getStatements(List<String> s, String relations, List<String> t, String keywords, String types, Integer pageNumber, Integer pageSize) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<BeaconStatement>> getStatementsWithHttpInfo(List<String> s, String relations, List<String> t, String keywords, String types, Integer pageNumber, Integer pageSize) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getStatementsAsync(List<String> s, String relations, List<String> t, String keywords, String types, Integer pageNumber, Integer pageSize, final ApiCallback<List<BeaconStatement>> callback) throws ApiException {
