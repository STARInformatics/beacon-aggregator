...
import bio.knowledge.server.ApiCallback;
import bio.knowledge.server.ApiClient;
import bio.knowledge.server.ApiException;
import bio.knowledge.server.ApiResponse;
import bio.knowledge.server.Configuration;
import bio.knowledge.server.Pair;
import bio.knowledge.server.ProgressRequestBody;
import bio.knowledge.server.ProgressResponseBody;
...
public class StatementsApi {
     ...
     */
    public List<InlineResponse2003> getStatements(List<String> c, Integer pageNumber, Integer pageSize, String keywords, String semgroups) throws ApiException {
        ApiResponse<List<InlineResponse2003>> resp = getStatementsWithHttpInfo(c, pageNumber, pageSize, keywords, semgroups);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<InlineResponse2003>> getStatementsWithHttpInfo(List<String> c, Integer pageNumber, Integer pageSize, String keywords, String semgroups) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getStatementsAsync(List<String> c, Integer pageNumber, Integer pageSize, String keywords, String semgroups, final ApiCallback<List<InlineResponse2003>> callback) throws ApiException {
