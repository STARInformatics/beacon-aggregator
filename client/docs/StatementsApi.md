...
# **getStatements**
> List&lt;InlineResponse2003&gt; getStatements(c, pageNumber, pageSize, keywords, semgroups)
...
try {
    List<InlineResponse2003> result = apiInstance.getStatements(c, pageNumber, pageSize, keywords, semgroups);
