...
# **getEvidence**
> List&lt;Annotation&gt; getEvidence(statementId, keywords, pageNumber, pageSize)
...
try {
    List<Annotation> result = apiInstance.getEvidence(statementId, keywords, pageNumber, pageSize);
