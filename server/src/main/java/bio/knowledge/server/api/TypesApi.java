...
public interface TypesApi {
    ...
    @ApiOperation(value = "", notes = "Get a list of types and number of instances in the knowledge source, and a link to the API call for the list of equivalent terminology ", response = ServerSummary.class, responseContainer = "List", tags={ "metadata", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<ServerSummary>> getConceptTypes( @ApiParam(value = "set of aggregator indices of beacons to be used as knowledge sources for the query ") @RequestParam(value = "beacons", required = false) List<String> beacons,
