...
public class ConceptsApiController implements ConceptsApi {
    ...
    public ResponseEntity<List<ServerConceptDetail>> getConceptDetails(@ApiParam(value = "(url-encoded) CURIE identifier of concept of interest, e.g. wd:Q126691",required=true ) @PathVariable("conceptId") String conceptId,
