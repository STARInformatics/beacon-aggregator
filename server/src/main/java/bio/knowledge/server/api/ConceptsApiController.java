...
public class ConceptsApiController implements ConceptsApi {
    ...
    public ResponseEntity<List<ServerConceptWithDetails>> getConceptDetails(@ApiParam(value = "(url-encoded) CURIE identifier of concept of interest, e.g. wd:Q126691",required=true ) @PathVariable("conceptId") String conceptId,
    ...
    public ResponseEntity<List<ServerConcept>> getConcepts( @NotNull @ApiParam(value = "a (urlencoded) space delimited set of keyword substrings against which to match concept names and synonyms, e.g. diabetes.", required = true) @RequestParam(value = "keywords", required = true) String keywords,
