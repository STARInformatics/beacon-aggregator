...
public class ConceptsApiController implements ConceptsApi {
    ...
    public ResponseEntity<List<ConceptWithDetails>> getConceptDetails(@ApiParam(value = "(url-encoded) CURIE identifier of clique of interest, e.g.wd:Q126691",required=true ) @PathVariable("cliqueId") String cliqueId,
